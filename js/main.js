...
if (reservadas <= libres) {
    alert("Usted acaba de reservar " + reservadas + " entradas, quedan disponibles " + (libres - reservadas))
    console.log("se reservaron " + reservadas + " entradas, quedan disponibles " + (libres - reservadas))
}
else {
    do {
